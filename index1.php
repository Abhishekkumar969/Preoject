...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    ...
    <!-- i class="fa fa-user-plus" aria-hidden="true" -->
      <a class="navbar-brand js-scroll-trigger" href="index.html" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><img src="images/logoMain.png" alt="" style="    width: 22%;
    padding-left: 37px;
    margin-top: 23px;
    margin-left: -31px;
    margin-bottom: 25px"></i>&nbsp Healing Junction</h4></a>
              ...
              <form class="form-group" method="POST" action="func.php">
                ...
                <div class="row">
                 ...
                 <!--  <div class="col-md-8" style="margin-top: 10%">
                    <a href="index2.php" class="btn btn-primary">Back</a></div> -->
                </div>
              </form>
            </center>
            </div>
